...
<body style="height: fit-content;width: inherit;">
    <div class="text-center text-sm-center text-md-center text-lg-center text-xl-center text-xxl-center align-content-center mt-sm-0" id="main" style="text-align: center;">
     ...
     style="width: inherit; filter: blur(0px); backdrop-filter: opacity(1) blur(10px); -webkit-backdrop-filter: opacity(1) blur(10px);" 
     id="navbar">
    <div class="container">
        ...
        <footer class="text-center bg-dark" id="footer">
            <div class="container text-white py-4 py-lg-5" style="height: 140px;">
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item"><a href="https://x.com/RajJaiswal1708" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-twitter-x text-light" style="font-size: 26px;margin-left: 16px;">
